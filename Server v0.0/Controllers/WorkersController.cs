...
namespace Server_v0._0.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WorkerID,LastName,FirstName,MiddleName,Salary,Email,IsDeleted")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkerID,LastName,FirstName,MiddleName,Salary,Email,IsDeleted")] Worker worker)
        {
