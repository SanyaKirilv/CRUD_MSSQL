...
namespace Server_v0._0.Controllers
{
    public class WorksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WorkID,StartDate,EndDate,WorkersCount,IsDeleted")] Work work)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkID,StartDate,EndDate,WorkersCount,IsDeleted")] Work work)
        {
            if (id != work.WorkID)
            {
                return NotFound();
